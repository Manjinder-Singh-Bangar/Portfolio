  ...
  return (
    <footer ref={footerRef} className='text-[#607B96] bg-[rgba(1,22,39,0.84)] justify-between flex p-0 border-t-2 border-t-[#1E2D3D]'>
        <div className='flex items-center'>
            ...
            <Link to={"https://x.com/manjinderxjs"} className='w-fit xs:p-[23px] lg:p-3 border-r-2 border-r-[#1E2D3D]'><img className=' ' src={twitterSvgSrc} alt="twitter" /></Link>
            <Link to={"https://www.facebook.com/manu.ngh.3"} className='w-fit xs:p-[23px] lg:p-3 border-r-2 border-r-[#1E2D3D]'><img className=' ' src={facebookSvgSrc} alt="Facebook" /></Link>
        </div>
